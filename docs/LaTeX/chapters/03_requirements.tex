...
The UI plan also supports the screenshot strategy of the thesis. Every major page should have a final screenshot in the submitted version. The screenshot list in Appendix A describes the exact captures required.
...
The most important risks are LLM hallucination, API rate limits, database limitations, CI instability, traceability gaps, and presentation risk. These risks are not equal. Hallucination and privacy risk are high impact because they can affect trust. SQLite contention is lower in the thesis context because the prototype is local and low concurrency. Presentation risk is mitigated through a recorded walkthrough and screenshot evidence.
...
\hline
Defense/demo instability & Medium & Use recorded walkthrough evidence and capture stable screenshots of final workflows.\\
\hline
\end{longtable}

...
\textbf{RQ4: How can the resulting prototype be evaluated with evidence available in a student thesis project?} This question concerns realistic validation. The thesis uses functional walkthroughs, automated tests, coverage, CI configuration, API documentation, and qualitative observations rather than claiming statistically broad user-study results.
...
The appendices provide a screenshot and visual-asset checklist and a detailed traceability matrix. These appendices are intended to support final review and defense preparation by making the evidence package explicit.
